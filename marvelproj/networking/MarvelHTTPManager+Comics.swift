...
extension MarvelHTTPManager{
    ...
    func fetchComics(characterID: Int, completion: @escaping (_ comics: [Comics], _ error: Error?) -> Void){
        ...
        let url = queryBuilder.query(ts: ts, apikey: dict.publicKey, hash: hash, characterID: characterID, detailExtension: "comics", limit: LIMIT_OF_FETCH_COLLECTION_VIEW_COMICS)
