...
let LIMIT_OF_COLLECTION_VIEW_CELLS_PER_CELL = 10
let LIMIT_OF_TABLE_VIEW_CELLS_STORIES = 10

let LIMIT_OF_FETCH_COLLECTION_VIEW_COMICS = 10
let LIMIT_OF_FETCH_COLLECTION_VIEW_SERIES = 10
let LIMIT_OF_FETCH_COLLECTION_VIEW_EVENTS = 10
let LIMIT_OF_FETCH_COLLECTION_VIEW_STORIES = 10
